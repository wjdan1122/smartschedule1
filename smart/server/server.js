...
app.use(
  cors({
    origin: [
      'http://localhost:3000', 
      'http://localhost:3001',
      '[https://smartschedule1-b64l.onrender.com](https://smartschedule1-b64l.onrender.com)',
      '[https://endearing-kulfi-c96605.netlify.app](https://endearing-kulfi-c96605.netlify.app)' // ✅ رابط موقعك الجديد
    ],
    credentials: true,
  })
);
...
// ============================================
// AI SCHEDULER ROUTE (UPDATED for gemini-1.5-flash)
// ============================================
app.post('/api/schedule/generate', authenticateToken, async (req, res) => {
  ...
  try {
    ...
    // ✅✅✅ CRITICAL AI FIX START ✅✅✅
    // Using gemini-1.5-flash with correct payload structure
