...
// ----------------------------------------------------------
// مسارات الإحصائيات (STATISTICS ROUTES) - تمت إضافته
// ----------------------------------------------------------
...
      commentsResult,
    ] = await Promise.all([
      // ملاحظة: نستخدم جداول users, votes, comments. تأكد من وجودها.
...
    // في حال عدم وجود الجداول (مثل votes أو comments) سيظهر هذا الخطأ
