    ...
    return (
        <div className="dashboard-page">
            <Container fluid="lg" className="container-custom shadow-lg">
                {/* ==========================================================
                ✅ شريط التنقل (Navbar) مطابق للصورة
                ========================================================== 
                */}
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        ...
                        <div className="d-flex align-items-center ms-lg-4 mt-3 mt-lg-0">
                            <div className="user-info text-white text-start me-3">
                                {/* تم دمج الاسم والبريد الإلكتروني في مكان واحد كما يظهر في الصورة (قد يظهر الاسم فقط في النهاية بناءً على تنسيق الـ CSS) */}
                                <span className="user-name fw-bold me-2">{user.name}</span>
                                <span className="user-role" style={{ opacity: 0.8, fontSize: '0.9rem' }}>{user.email}</span>
                            </div>
